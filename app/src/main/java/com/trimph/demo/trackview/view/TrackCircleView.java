...
public class TrackCircleView extends View {
    ...
    public TrackCircleView(Context context) {
        this(context, null);
    }

    public TrackCircleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mData[0] = 0;   //0
        mData[1] = mCircleRadius;  //200

        mData[2] = mCircleRadius;     // 200
        mData[3] = 0;            //0
...
//        mData[3] = 0;            //0
        // 初始化控制
        mCtrl[0] = mData[0] + mDifference;    //100
        mCtrl[1] = mData[1];          //200

        mCtrl[2] = mData[2];           //200
        mCtrl[3] = mData[3] + mDifference;  //100
...
//////***********---------------------------************///////////////
        ...
        mCtrl[12] = mData[6];         //-200
        mCtrl[13] = mData[7] + mDifference;  // 100

        mCtrl[14] = mData[0] - mDifference; // -100
        mCtrl[15] = mData[1];            //200
